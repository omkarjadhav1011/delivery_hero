...
- **Run `/dh` for everything planned:** it plans, resumes, checks, picks the next subplan and runs it, asking before anything that needs approval. `/dh status` changes nothing.
