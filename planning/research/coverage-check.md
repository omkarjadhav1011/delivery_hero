...
| Dates match the Charter's milestones (section 12) | Walking skeleton Tue 29 Sep (S0-06); task review Wed 7 Oct (S2-25); Must features by Mon 12 Oct (S2 Must subplans end Sun 11 Oct); load test Tue 13 Oct (S2-27); trial and go/no-go Wed 14 Oct (T-01); content freeze Fri 16 Oct and documents 17–18 by Mon 19 Oct (H-05); deployment freeze Tue 20 Oct (FZ-01); event Wed 21 Oct (E-01); close and survey Thu 22 Oct, lessons Tue 27 Oct (AE-01): all match |
