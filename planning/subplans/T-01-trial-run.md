...
- [ ] T4 Owner: 30 minutes before, set up the laptop and projector, check `/health` and the company network's access to the subdomain (hotspot as fallback), and create a test game on the Default 5-minute plan with bots to bring the room to about 40 players, test first: none, source: R-07, NFR-36, DEC-193, E2E-05 (shared), document 14 Appendix C [Blocked: waiting for Q-01]
- [ ] T5 Owner: open the lobby, start the stopwatch at "scan now", read the join counter at 30 seconds, then run the practice round, test first: none, source: TRIAL-01, NFR-38, FR-014 to FR-017, document 14 Appendix C [Blocked: waiting for Q-01]
- [ ] T6 Owner: play the full 5-minute round with players on 4G; two volunteers switch airplane mode on for 20 and 60 seconds; afterwards void one task and drive the reveal with the clicker, test first: none, source: TRIAL-03, TRIAL-04, TRIAL-05, R-08, NFR-01, NFR-03, AC-US61-01 (shared), MAN-04 (shared), document 14 Appendix C [Blocked: waiting for Q-01]
- [ ] T7 Owner: players check their results, review and hero cards; close the test game; then play a short real game on the Quick 3-minute plan with real players only, close it, check past games and run OPS-13, test first: none, source: TRIAL-06, OPS-13 (shared), FR-086, FR-087, NFR-23, document 14 Appendix C [Blocked: waiting for Q-01]
- [ ] T8 Owner: run the survey (fun 1–5, clarity 1–5, anything confusing?) and the 10-minute debrief, and log each issue as a GitHub issue labeled `bug`, a severity and `found-in:trial`, test first: none, source: TRIAL-07, DEC-193, TP-09, DEC-190, document 14 section 12 [Blocked: waiting for Q-01]
- [ ] T9 Owner: after the trial, check the backend logs for errors, the restart count, CPU and memory peaks and the server's answer processing times, and inspect the database, logs and backup for player data, test first: none, source: TRIAL-02, TRIAL-03, NFR-04, NFR-23, document 14 Appendix C [Blocked: waiting for Q-01]
