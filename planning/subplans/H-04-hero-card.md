...
- [ ] T3 Play styles from fast and accurate with thresholds from `scoring.yml` (Firefighter, Auditor, Cowboy, Philosopher), in `app.deliveryhero.scoring` and `app.deliveryhero.config` (`ScoringConfig`), test first: `HeroCardServiceTest` AC-US48-04, source: AC-US48-04, BR-12, DEC-28
