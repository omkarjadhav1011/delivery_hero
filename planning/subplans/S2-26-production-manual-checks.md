...
- [ ] T2 Owner: OPS-07 uptime alert: outside game time, with the monitor from OA-22 in place, stop the backend for 11 minutes, then start it; the alert email arrives after two failed checks; record OPS-07 in `check-results.md` and AC-US69-03 (shared) in `test-results/manual-results.csv`, test first: none, source: OPS-07, AC-US69-03 (shared), FR-091 (shared), DEC-204 (shared), document 16 section 11.7 [Blocked: waiting for Q-01]
