...
- [ ] T2 Build the task library screen with the filters and the search box, in `frontend/app/admin/tasks` and `frontend/src/admin/components`, test first: E2E-04 `content-admin` step 2 filter check (Tester and Tap to order give exactly three tasks) named AC-US52-01, source: AC-US52-01, FR-070, document 12 section 9 (Task library screen), E2E-04 (shared)
