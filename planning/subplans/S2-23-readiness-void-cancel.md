...
- [ ] T8 Void and Cancel controls on the live control screen, enabled only by `allowedActions`, with the A-09 confirmation dialogs, and "The host ended this game." on phones and the projector, in `frontend/src/admin/components/`, `frontend/src/player/screens/` and `frontend/src/screen/views/`, test first: `LiveControl.test.tsx` citing AC-US61-01 and AC-US62-01, source: AC-US61-01, AC-US62-01, document 12 A-09
