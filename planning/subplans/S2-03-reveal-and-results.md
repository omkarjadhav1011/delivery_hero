...
- [ ] T8 Add "Start reveal", Next and Back to live control, with Right arrow, Down arrow, Page Down, Space and Enter moving forward and Left arrow, Up arrow and Page Up moving back while the screen has focus (the keys a presentation clicker sends), in `frontend/src/admin/components`, test first: `LiveControl.test.tsx` cases named AC-US43-02, source: AC-US43-02, AC-US43-03, FR-059, A-09 (shared)
